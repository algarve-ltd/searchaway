         ...
         <div className="container">
            ...
            <div className="row mb-80">
               <div className="col-lg-8 mx-auto text-center">
                  <h1 className="mb-30 wow fadeInUp" data-wow-delay=".2s">About Us – SearchAway</h1>
                  <p className="lead mb-0 wow fadeInUp" data-wow-delay=".3s">
            ...
            <div className="row align-items-center mb-80">
               ...
               <div className="col-lg-6 mb-30">
                  <div className="tg-about-thumb-wrap">
                     ...
                     <div className="bg-light rounded-15 d-flex align-items-center justify-content-center" style={{ height: '300px' }}>
                        <span className="text-muted">Image: Travel Advisors at Work</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="row align-items-center mb-80">
               ...
               <div className="col-lg-6 mb-30 order-lg-1">
                  <div className="tg-about-thumb-wrap">
                     {/* Image placeholder - replace with actual image */}
                     <div className="bg-light rounded-15 d-flex align-items-center justify-content-center" style={{ height: '350px' }}>
                        <span className="text-muted">Image: Personal Service Illustration</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="row align-items-center mb-80">
               ...
               <div className="col-lg-6 mb-30">
                  <div className="tg-about-thumb-wrap">
                     {/* Image placeholder - replace with actual image */}
                     <div className="bg-light rounded-15 d-flex align-items-center justify-content-center" style={{ height: '300px' }}>
                        <span className="text-muted">Image: Independent Travel Advisors</span>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="row">
               <div className="col-lg-10 mx-auto">
                  <div className="bg-primary text-white rounded-15 p-40 text-center wow fadeInUp" data-wow-delay=".3s">
                     <h2 className="text-white mb-25">Book With Confidence</h2>
                     <p className="mb-20">
